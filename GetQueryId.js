...
async function GetQueryId(QraphlName, noCheck, forcedUpdate) {
    ...
    if ((QueryIdListData.mainJsId != mainJsId && !noCheck) || !Object.keys(QueryIdListData).length || forcedUpdate) {
        
        //Prase main.xxxxxxxx.js file to get queryId 
        let mainJsUrl = 'https://abs.twimg.com/responsive-web/client-web-legacy/main.' + mainJsId + '.js';
